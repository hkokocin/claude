...
- `SKILL.md` — skill metadata (not user-invocable; workers are spawned by task_manager)

## How It Works

The task_manager orchestrator spawns worker sessions using `design-async.md` as the system prompt.
